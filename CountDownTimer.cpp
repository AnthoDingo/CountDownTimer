...
void CountDownTimer::StopTimerAt(unsigned long hours, unsigned long minutes, unsigned long seconds)
{
...
void CountDownTimer::SetTimer(unsigned long hours, unsigned long minutes, unsigned long seconds)
{
...
void CountDownTimer::SetTimer(unsigned long seconds)
{
...
long CountDownTimer::ShowHours()
{
  return Clock / 3600;
}

long CountDownTimer::ShowMinutes()
{
  return (Clock / 60) % 60;
}

long CountDownTimer::ShowSeconds()
{
  return Clock % 60;
}
...
bool CountDownTimer::TimeCheck(unsigned long hours, unsigned long minutes, unsigned long seconds) // output true if timer equals requested time
{
